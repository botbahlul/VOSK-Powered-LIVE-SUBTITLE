...
ANDROID APP that can recognize words of any LIVE AUDIO/VIDEO STREAMING (powered by VOSK) then TRANSLATE (powered by ANDROID MLKIT TRANSLATE) and display them as SUBTITLES
